/**
 * Thin `node:child_process` wrapper shared by skopeo.ts/cosign.ts. Every external-binary
 * invocation in this package goes through here so there is exactly one place that logs the
 ...
 * and file paths in this package can contain characters (`:`, `/`, `@`) that would be

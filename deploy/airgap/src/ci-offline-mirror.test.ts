...
/** THE OFFLINE-CI GATE. See docs/airgap/ci-offline-mirror.test.md §1. */
...
/** Every `.ts` in the tree EXCEPT this file. See docs/airgap/ci-offline-mirror.test.md §2. */
...
/** Read and comment-strip the whole tree ONCE. See docs/airgap/ci-offline-mirror.test.md §3. */
...
/** THE VAR MUST ARRIVE, NOT MERELY BE EXPORTED. See docs/airgap/ci-offline-mirror.test.md §4. */

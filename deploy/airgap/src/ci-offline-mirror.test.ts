...
/** THE OFFLINE-CI GATE. See docs/airgap.md §22. */
...
/** Every `.ts` in the tree EXCEPT this file. See docs/airgap.md §23. */
...
/** Read and comment-strip the whole tree ONCE. See docs/airgap.md §24. */
...
describe("every image a source file names is mirrored", () => {
  ...
  /** skopeo talks to a registry and never sees the local store. See docs/airgap.md §26. */
...
/** THE VAR MUST ARRIVE, NOT MERELY BE EXPORTED. See docs/airgap.md §27. */
describe("every var the seed step exports actually reaches the process that reads it", () => {
  ...
  /** The only seeded vars whose consumer runs outside turbo. See docs/airgap.md §28. */

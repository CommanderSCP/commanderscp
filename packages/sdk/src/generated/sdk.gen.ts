 ...
 */
export const releaseStackOwnership = <ThrowOnError extends boolean = false>(options: Options<ReleaseStackOwnershipData, ThrowOnError>): RequestResult<ReleaseStackOwnershipResponses, ReleaseStackOwnershipErrors, ThrowOnError> => (options.client ?? client).post<ReleaseStackOwnershipResponses, ReleaseStackOwnershipErrors, ThrowOnError>({
    responseValidator: async (data) => await zReleaseStackOwnershipResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const setSourceMappingJourneyKind = <ThrowOnError extends boolean = false>(options: Options<SetSourceMappingJourneyKindData, ThrowOnError>): RequestResult<SetSourceMappingJourneyKindResponses, SetSourceMappingJourneyKindErrors, ThrowOnError> => (options.client ?? client).patch<SetSourceMappingJourneyKindResponses, SetSourceMappingJourneyKindErrors, ThrowOnError>({
    responseValidator: async (data) => await zSetSourceMappingJourneyKindResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getInfrastructureMembers = <ThrowOnError extends boolean = false>(options: Options<GetInfrastructureMembersData, ThrowOnError>): RequestResult<GetInfrastructureMembersResponses, GetInfrastructureMembersErrors, ThrowOnError> => (options.client ?? client).get<GetInfrastructureMembersResponses, GetInfrastructureMembersErrors, ThrowOnError>({
    responseValidator: async (data) => await zGetInfrastructureMembersResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const reportInfrastructureMembers = <ThrowOnError extends boolean = false>(options: Options<ReportInfrastructureMembersData, ThrowOnError>): RequestResult<ReportInfrastructureMembersResponses, ReportInfrastructureMembersErrors, ThrowOnError> => (options.client ?? client).put<ReportInfrastructureMembersResponses, ReportInfrastructureMembersErrors, ThrowOnError>({
    responseValidator: async (data) => await zReportInfrastructureMembersResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/infrastructure-products/{idOrUrn}/members',
    ...options,
    headers: {
 ...
 */
export const getTrustDomainSshCaEnrolment = <ThrowOnError extends boolean = false>(options: Options<GetTrustDomainSshCaEnrolmentData, ThrowOnError>): RequestResult<GetTrustDomainSshCaEnrolmentResponses, GetTrustDomainSshCaEnrolmentErrors, ThrowOnError> => (options.client ?? client).get<GetTrustDomainSshCaEnrolmentResponses, GetTrustDomainSshCaEnrolmentErrors, ThrowOnError>({
    responseValidator: async (data) => await zGetTrustDomainSshCaEnrolmentResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const enrolTrustDomainSshCa = <ThrowOnError extends boolean = false>(options: Options<EnrolTrustDomainSshCaData, ThrowOnError>): RequestResult<EnrolTrustDomainSshCaResponses, EnrolTrustDomainSshCaErrors, ThrowOnError> => (options.client ?? client).post<EnrolTrustDomainSshCaResponses, EnrolTrustDomainSshCaErrors, ThrowOnError>({
    responseValidator: async (data) => await zEnrolTrustDomainSshCaResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/trust-domains/{domainId}/ssh-ca/enrolment',
    ...options,
    headers: {
 ...
 */
export const getTrustDomainArgoOpsPin = <ThrowOnError extends boolean = false>(options: Options<GetTrustDomainArgoOpsPinData, ThrowOnError>): RequestResult<GetTrustDomainArgoOpsPinResponses, GetTrustDomainArgoOpsPinErrors, ThrowOnError> => (options.client ?? client).get<GetTrustDomainArgoOpsPinResponses, GetTrustDomainArgoOpsPinErrors, ThrowOnError>({
    responseValidator: async (data) => await zGetTrustDomainArgoOpsPinResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const putTrustDomainArgoOpsPin = <ThrowOnError extends boolean = false>(options: Options<PutTrustDomainArgoOpsPinData, ThrowOnError>): RequestResult<PutTrustDomainArgoOpsPinResponses, PutTrustDomainArgoOpsPinErrors, ThrowOnError> => (options.client ?? client).put<PutTrustDomainArgoOpsPinResponses, PutTrustDomainArgoOpsPinErrors, ThrowOnError>({
    responseValidator: async (data) => await zPutTrustDomainArgoOpsPinResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/trust-domains/{domainId}/ssh-ca/argo-ops-pin',
    ...options,
    headers: {
 ...
 */
export const listSshCertificateIssuances = <ThrowOnError extends boolean = false>(options?: Options<ListSshCertificateIssuancesData, ThrowOnError>): RequestResult<ListSshCertificateIssuancesResponses, ListSshCertificateIssuancesErrors, ThrowOnError> => (options?.client ?? client).get<ListSshCertificateIssuancesResponses, ListSshCertificateIssuancesErrors, ThrowOnError>({
    responseValidator: async (data) => await zListSshCertificateIssuancesResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const reconcileSshCertificateSerials = <ThrowOnError extends boolean = false>(options: Options<ReconcileSshCertificateSerialsData, ThrowOnError>): RequestResult<ReconcileSshCertificateSerialsResponses, ReconcileSshCertificateSerialsErrors, ThrowOnError> => (options.client ?? client).post<ReconcileSshCertificateSerialsResponses, ReconcileSshCertificateSerialsErrors, ThrowOnError>({
    responseValidator: async (data) => await zReconcileSshCertificateSerialsResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const redeemOpsRun = <ThrowOnError extends boolean = false>(options: Options<RedeemOpsRunData, ThrowOnError>): RequestResult<RedeemOpsRunResponses, RedeemOpsRunErrors, ThrowOnError> => (options.client ?? client).post<RedeemOpsRunResponses, RedeemOpsRunErrors, ThrowOnError>({
    responseValidator: async (data) => await zRedeemOpsRunResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getStack = <ThrowOnError extends boolean = false>(options?: Options<GetStackData, ThrowOnError>): RequestResult<GetStackResponses, GetStackErrors, ThrowOnError> => (options?.client ?? client).get<GetStackResponses, GetStackErrors, ThrowOnError>({
    responseValidator: async (data) => await zGetStackResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/instance/stack',
    ...options
});
 ...
 */
export const putStackBackend = <ThrowOnError extends boolean = false>(options: Options<PutStackBackendData, ThrowOnError>): RequestResult<PutStackBackendResponses, PutStackBackendErrors, ThrowOnError> => (options.client ?? client).put<PutStackBackendResponses, PutStackBackendErrors, ThrowOnError>({
    responseValidator: async (data) => await zPutStackBackendResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/instance/stack/backends/{backend}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 */
export const purgeStackBackend = <ThrowOnError extends boolean = false>(options: Options<PurgeStackBackendData, ThrowOnError>): RequestResult<PurgeStackBackendResponses, PurgeStackBackendErrors, ThrowOnError> => (options.client ?? client).post<PurgeStackBackendResponses, PurgeStackBackendErrors, ThrowOnError>({
    responseValidator: async (data) => await zPurgeStackBackendResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const putStackSettings = <ThrowOnError extends boolean = false>(options: Options<PutStackSettingsData, ThrowOnError>): RequestResult<PutStackSettingsResponses, PutStackSettingsErrors, ThrowOnError> => (options.client ?? client).put<PutStackSettingsResponses, PutStackSettingsErrors, ThrowOnError>({
    responseValidator: async (data) => await zPutStackSettingsResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/instance/stack/settings',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 */
export const requestStackUpgrade = <ThrowOnError extends boolean = false>(options?: Options<RequestStackUpgradeData, ThrowOnError>): RequestResult<RequestStackUpgradeResponses, RequestStackUpgradeErrors, ThrowOnError> => (options?.client ?? client).post<RequestStackUpgradeResponses, RequestStackUpgradeErrors, ThrowOnError>({
    responseValidator: async (data) => await zRequestStackUpgradeResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/instance/stack/upgrade',
    ...options
});
 ...
 */
export const getStackDiagnostics = <ThrowOnError extends boolean = false>(options?: Options<GetStackDiagnosticsData, ThrowOnError>): RequestResult<GetStackDiagnosticsResponses, GetStackDiagnosticsErrors, ThrowOnError> => (options?.client ?? client).get<GetStackDiagnosticsResponses, GetStackDiagnosticsErrors, ThrowOnError>({
    responseValidator: async (data) => await zGetStackDiagnosticsResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/instance/stack/diagnostics',
    ...options
});
 ...
 */
export const getStackSpec = <ThrowOnError extends boolean = false>(options?: Options<GetStackSpecData, ThrowOnError>): RequestResult<GetStackSpecResponses, GetStackSpecErrors, ThrowOnError> => (options?.client ?? client).get<GetStackSpecResponses, GetStackSpecErrors, ThrowOnError>({
    responseValidator: async (data) => await zGetStackSpecResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/instance/stack/spec',
    ...options
});
 ...
 */
export const putStackStatus = <ThrowOnError extends boolean = false>(options: Options<PutStackStatusData, ThrowOnError>): RequestResult<PutStackStatusResponses, PutStackStatusErrors, ThrowOnError> => (options.client ?? client).put<PutStackStatusResponses, PutStackStatusErrors, ThrowOnError>({
    responseValidator: async (data) => await zPutStackStatusResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/instance/stack/status',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
/**
 * Whether the caller's own session holds the instance-operator role
 */
export const getInstanceOperatorSelf = <ThrowOnError extends boolean = false>(options?: Options<GetInstanceOperatorSelfData, ThrowOnError>): RequestResult<GetInstanceOperatorSelfResponses, GetInstanceOperatorSelfErrors, ThrowOnError> => (options?.client ?? client).get<GetInstanceOperatorSelfResponses, GetInstanceOperatorSelfErrors, ThrowOnError>({
    responseValidator: async (data) => await zGetInstanceOperatorSelfResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Every instance-operator grant, live and revoked (instance authority required)
 */
export const listInstanceOperators = <ThrowOnError extends boolean = false>(options?: Options<ListInstanceOperatorsData, ThrowOnError>): RequestResult<ListInstanceOperatorsResponses, ListInstanceOperatorsErrors, ThrowOnError> => (options?.client ?? client).get<ListInstanceOperatorsResponses, ListInstanceOperatorsErrors, ThrowOnError>({
    responseValidator: async (data) => await zListInstanceOperatorsResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const grantInstanceOperator = <ThrowOnError extends boolean = false>(options: Options<GrantInstanceOperatorData, ThrowOnError>): RequestResult<GrantInstanceOperatorResponses, GrantInstanceOperatorErrors, ThrowOnError> => (options.client ?? client).post<GrantInstanceOperatorResponses, GrantInstanceOperatorErrors, ThrowOnError>({
    responseValidator: async (data) => await zGrantInstanceOperatorResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/instance/operators',
    ...options,
    headers: {
 ...
 */
export const listInstanceAuditEvents = <ThrowOnError extends boolean = false>(options?: Options<ListInstanceAuditEventsData, ThrowOnError>): RequestResult<ListInstanceAuditEventsResponses, ListInstanceAuditEventsErrors, ThrowOnError> => (options?.client ?? client).get<ListInstanceAuditEventsResponses, ListInstanceAuditEventsErrors, ThrowOnError>({
    responseValidator: async (data) => await zListInstanceAuditEventsResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getExecutionSystemSourceAllowlist = <ThrowOnError extends boolean = false>(options: Options<GetExecutionSystemSourceAllowlistData, ThrowOnError>): RequestResult<GetExecutionSystemSourceAllowlistResponses, GetExecutionSystemSourceAllowlistErrors, ThrowOnError> => (options.client ?? client).get<GetExecutionSystemSourceAllowlistResponses, GetExecutionSystemSourceAllowlistErrors, ThrowOnError>({
    responseValidator: async (data) => await zGetExecutionSystemSourceAllowlistResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const putExecutionSystemSourceAllowlist = <ThrowOnError extends boolean = false>(options: Options<PutExecutionSystemSourceAllowlistData, ThrowOnError>): RequestResult<PutExecutionSystemSourceAllowlistResponses, PutExecutionSystemSourceAllowlistErrors, ThrowOnError> => (options.client ?? client).put<PutExecutionSystemSourceAllowlistResponses, PutExecutionSystemSourceAllowlistErrors, ThrowOnError>({
    responseValidator: async (data) => await zPutExecutionSystemSourceAllowlistResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/execution-systems/{idOrUrn}/source-allowlist',
    ...options,
    headers: {

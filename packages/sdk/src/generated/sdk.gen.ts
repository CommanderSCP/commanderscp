 ...
 */
export const deleteStackAuthoring = <ThrowOnError extends boolean = false>(options?: Options<DeleteStackAuthoringData, ThrowOnError>): RequestResult<DeleteStackAuthoringResponses, DeleteStackAuthoringErrors, ThrowOnError> => (options?.client ?? client).delete<DeleteStackAuthoringResponses, DeleteStackAuthoringErrors, ThrowOnError>({
    responseValidator: async (data) => await zDeleteStackAuthoringResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const putStackAuthoring = <ThrowOnError extends boolean = false>(options: Options<PutStackAuthoringData, ThrowOnError>): RequestResult<PutStackAuthoringResponses, PutStackAuthoringErrors, ThrowOnError> => (options.client ?? client).put<PutStackAuthoringResponses, PutStackAuthoringErrors, ThrowOnError>({
    responseValidator: async (data) => await zPutStackAuthoringResponse.parseAsync(data),
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/instance/stack/authoring',
    ...options,
    headers: {

...
export type CreatePlanData = {
    body: {
        manifest: {
            ...
            /**
             * Dependency-line producer declarations (ADR-0032 §7e). UNLIKE every other collection here, an ABSENT 'producers' key means UNMANAGED and prunes NOTHING — retracting a declaration returns a coordinate the org publishes to a public index on a poll timer, so a forgotten key must not re-arm dependency confusion. A PRESENT collection IS authoritative over its members: removing an entry prunes that declaration, and a present-but-empty array prunes every declaration on a component this stack owns. Because Stack.synth() omits an empty collection, @scp/coordination-as-code cannot retract the LAST declaration — use POST /dependencies/producers/retract (which also reports the bumps already in flight), or hand-author "producers": []. Ownership follows the producer COMPONENT; a plan that would take a coordinate from a producer this stack does not own is refused.
             */
            producers?: Array<{
                producerUrn: string;
            ...
            /**
             * governance:move enforcement rungs (ADR-0038 §2). LIKE 'producers' and UNLIKE every other collection here, an ABSENT key means UNMANAGED and disables NOTHING — a rung is a governance bar, and the symptom of dropping one is an absence of refusals. A PRESENT collection IS authoritative over its members: removing an entry disables that rung, and a present-but-empty array disables every rung on a container this stack owns. Because Stack.synth() omits an empty collection, @scp/coordination-as-code cannot disable the LAST rung — use DELETE /governance/move-enforcement/rungs/{idOrUrn}, or hand-author "governanceMoveRungs": []. The subject must be a CONTAINER this stack declares; apply requires policy:write at-or-above it, and a disable under an enabled upper rung is refused 409.
             */
            governanceMoveRungs?: Array<{
                subjectIdOrUrn: string;
            }>;
            /**
             * Pipeline test/bake hooks (D11/D21). LIKE 'producers' and 'governanceMoveRungs' and UNLIKE mappings/bindings/placements, an ABSENT key means UNMANAGED and prunes NOTHING — a hook is a gate, and the symptom of dropping one is an absence of refusals. A PRESENT collection IS authoritative over its members: removing an entry prunes that hook, and a present-but-empty array prunes every hook on a component this stack owns. Because Stack.synth() omits an empty collection, @scp/coordination-as-code cannot remove the LAST hook — remove one while others remain, or hand-author "pipelineHooks": []. Identity is (componentUrn, kind, hookId); a changed hook is a delete + create.
             */
            pipelineHooks?: Array<{
                kind: 'postMerge';
                componentUrn: string;
...
export type PutStackBackendData = {
    body: {
        enabled: boolean;
        sizeTier?: 'small' | 'medium' | 'large';
    };
...
export type PutStackBackendErrors = {
    /**
     * Error
     */
    400: {
...
export type PutStackBackendResponses = {
    /**
     * Success
     */
    200: {
...
export type PutStackSettingsErrors = {
    /**
     * Error
     */
    400: {
...
export type PutStackSettingsResponses = {
    /**
     * Success
     */
    200: {
...
export type PutStackSettingsResponse = PutStackSettingsResponses[keyof PutStackSettingsResponses];

export type RequestStackUpgradeData = {
    body?: never;
    path?: never;
    query?: never;
...
export type RequestStackUpgradeErrors = {
    /**
     * Error
     */
    400: {
...
export type RequestStackUpgradeError = RequestStackUpgradeErrors[keyof RequestStackUpgradeErrors];

export type RequestStackUpgradeResponses = {
    /**
     * Success
     */
    200: {
...
export type RequestStackUpgradeResponse = RequestStackUpgradeResponses[keyof RequestStackUpgradeResponses];

export type GetStackDiagnosticsData = {
    body?: never;
    path?: never;
    query?: never;
...
export type GetStackDiagnosticsErrors = {
    /**
     * Error
     */
    401: {
...
export type GetStackDiagnosticsError = GetStackDiagnosticsErrors[keyof GetStackDiagnosticsErrors];

export type GetStackDiagnosticsResponses = {
    /**
     * Success
     */
    200: {
...
export type GetStackDiagnosticsResponse = GetStackDiagnosticsResponses[keyof GetStackDiagnosticsResponses];

export type GetStackSpecData = {
    body?: never;
    path?: never;
    query?: never;
...
export type GetStackSpecErrors = {
    /**
     * Error
     */
    401: {
...
export type GetStackSpecError = GetStackSpecErrors[keyof GetStackSpecErrors];

export type GetStackSpecResponses = {
    /**
     * Success
     */
    200: {
...
export type GetStackSpecResponse = GetStackSpecResponses[keyof GetStackSpecResponses];

export type PutStackStatusData = {
    body: {
        release: string;
        observedUpgradeGeneration: number;
        backends: Array<{
            backend: 'argocd' | 'argo-workflows' | 'argo-rollouts' | 'argo-events' | 'gitea';
            phase: 'installing' | 'ready' | 'degraded' | 'upgrading' | 'failed' | 'removing' | 'disabled';
            runningVersion: string | null;
...
export type PutStackStatusErrors = {
    /**
     * Error
     */
    400: {
...
export type PutStackStatusError = PutStackStatusErrors[keyof PutStackStatusErrors];

export type PutStackStatusResponses = {
    /**
     * Success
     */
    204: void;

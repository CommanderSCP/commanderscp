...
// M2 typed registries (DESIGN.md — BUILD_AND_TEST.md §8 M2 item 1). See docs/sdk/client.md §1.
...
export class ScpClient {
  ...
  // `scp doctor` — read-only operational self-checks. See docs/sdk/client.md §2.
  ...
  // M4 Governance Engine (BUILD_AND_TEST.md §8 M4, DESIGN §10). See docs/sdk/client.md §3.
  ...
  readonly freezes = {
    ...
    /** M25.1 — move a freeze's `endsAt`, in EITHER direction. See docs/sdk/client.md §4. */
  ...
  // THE PRODUCER DECLARATION. See docs/sdk/client.md §5.
  readonly dependencyProducers = {
    /** DECLARE that a component produces this coordinate. See docs/sdk/client.md §6. */
    declare: async (
  ...
  readonly federation = {
    ...
    reconcileOutpost: async (
      peerDomainId: string,
      /** N9 — `keep` names the row that should SURVIVE. See docs/sdk/client.md §7. */
  ...
  // The live event stream (`GET /events/stream`, DESIGN §6/§8). See docs/sdk/client.md §8.

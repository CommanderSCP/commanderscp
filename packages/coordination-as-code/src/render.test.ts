...
/** The render shows all gates that apply, including inherited. See docs/coordination-as-code.md §310. */
...
describe("@scp/coordination-as-code: renderManifestPipelines — what the manifest itself declares", () => {
...
describe("@scp/coordination-as-code: renderManifestSection — D21(d)'s all-gates honesty requirement", () => {
...
describe("@scp/coordination-as-code: formatPipelineBlock — the comment-block shape a source file embeds", () => {
...
describe("@scp/coordination-as-code: updateGeneratedSection — --write's drift-checkable in-place update", () => {
...
describe("@scp/coordination-as-code: render determinism (fast-check) — the construct.determinism.test.ts pattern", () => {

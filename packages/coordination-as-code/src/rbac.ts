...
/** TYPED RBAC CONSTRUCTS. See docs/coordination-as-code.md §306. */
...
/** Grants a role to a `user` or `service-account` at a scope. ``. See docs/coordination-as-code.md §307. */
...
/** Declares an organization-defined role. ``. See docs/coordination-as-code.md §308. */
...
/** Refuses a group subject with the reason and the alternative. See docs/coordination-as-code.md §309. */

...
/** D24's compile-rung derivation has two layers. See docs/coordination-as-code.md §267. */
describe("@scp/coordination-as-code: PLACEMENT_MATRIX parity with @scp/schemas's ARTIFACT_INFRA_COMPATIBILITY", () => {
...
describe("@scp/coordination-as-code: infra product constructs are `deployment-target` objects (D19/D24)", () => {

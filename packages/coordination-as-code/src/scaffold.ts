/** Scaffold grouping: the pure decision behind the command. See docs/coordination-as-code.md §316. */
...
/** Groups a `discovery run` proposal's components into services. See docs/coordination-as-code.md §317. */

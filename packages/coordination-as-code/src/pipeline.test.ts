...
describe("@scp/coordination-as-code: pipeline-kind classes (D17) — closed-vocabulary exhaustiveness", () => {
...
describe("@scp/coordination-as-code: repos() (D18)", () => {
...
describe("@scp/coordination-as-code: Component root form (D15a/D17 — 'a multi-pipeline repo roots at Component')", () => {
...
describe("@scp/coordination-as-code: root-form pipeline (single-pipeline repo, D15a/D17)", () => {
...
describe("@scp/coordination-as-code: repo is required (D18) — mutation-proved guard", () => {
...
describe("@scp/coordination-as-code: adoptTopologyUrn (§9/D5) — the export/adopt affordance", () => {
  ...
  // MUTATION-PROVED (restored before commit). See docs/coordination-as-code.md §280.
...
describe("@scp/coordination-as-code: nested pipelines under a Component (multi-pipeline repo, D17)", () => {
...
describe("@scp/coordination-as-code: shared-rung pipeline (D8's deliberate exception — scoped to a Service)", () => {
...
describe("@scp/coordination-as-code: placement inference from waves (D8)", () => {
...
describe("@scp/coordination-as-code: placeAt (D19/D20/D24) — a real `placements` entry, targeting a deployment-target-typed object", () => {
...
describe("@scp/coordination-as-code: dependsOn sugar on a pipeline", () => {

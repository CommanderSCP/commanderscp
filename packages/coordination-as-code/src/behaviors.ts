/** TYPED PIPELINE BEHAVIOURS. See docs/coordination-as-code.md §172. */
...
/** The scope chain a behaviour needs. See docs/coordination-as-code.md §173. */
...
/** WHERE A TEST'S CODE AND TEMPLATE LIVE. See docs/coordination-as-code.md §174. */
...
/** Post-merge gates entry to the first wave, on merge. See docs/coordination-as-code.md §175. */
...
export interface ContinuousTestProps {
  ...
  /** Evidence older than this reads as ABSENT. See docs/coordination-as-code.md §176. */
...
/** Bake alarms: a quiet window that must pass alarm-free. See docs/coordination-as-code.md §177. */

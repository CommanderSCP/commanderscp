...
/** The compile rung, proved the way this repo already does. See docs/coordination-as-code.md §279. */
describe("@scp/coordination-as-code: placeAt is kind-checked at compile time (D24)", () => {

...
/** A real, non-stubbed HTTP client for this package's tests. See docs/plugins.md §517. */
...
/** A context whose client is the real Node-backed one above. See docs/plugins.md §518. */

...
/** WHAT THIS FILE COMPOSES. See docs/reference/packages/plugins/managed-iac/src/index.md §1. */
...
/** THE LAUNCHER SEAM. See docs/reference/packages/plugins/managed-iac/src/index.md §2. */
...
export const manifest: PluginManifest = {
  ...
  configSchema: {
    ...
    properties: {
      ...
      // BOUNDED AT BOTH ENDS. See docs/reference/packages/plugins/managed-iac/src/index.md §3.
      timeoutMs: {
        type: "integer",

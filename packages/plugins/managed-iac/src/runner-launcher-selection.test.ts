...
/** The standing gate that adapter selection is installed. See docs/plugins.md §454. */
...
describe("M23.2: managed-iac, constructed the way production constructs it, honours the selection", () => {
  ...
  /** No process is spawned on the Kubernetes path. See docs/plugins.md §455. */
  ...
  /** Never constructed, which is stronger than never called. See docs/plugins.md §456. */
...
/** M23.6 CLAUSE 1, BEHAVIOURALLY. See docs/plugins.md §457. */
...
/** M23.6 CLAUSE 1, THE HOLE EVERY CASE ABOVE LEFT. See docs/plugins.md §458. */

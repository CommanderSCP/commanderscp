...
export abstract class Construct {
  ...
  /** Slash-joined construct-tree path from the root, e.g. See docs/iac/construct.md §1. */
  get path(): string {
    const parts: string[] = [];
...
/** Root scope every `Stack` sits under. See docs/iac/construct.md §2. */
...
export class Stack extends Construct {
  ...
  /** L1 — the guaranteed raw manifest-entry door (D16(1)). See docs/iac/construct.md §3. */
  addManifestEntry(object: ManifestObject): this {
    this.rawObjectDecls.push(object);
    return this;
  }

  /** L1 — the guaranteed raw relationship door (D16(1)). See docs/iac/construct.md §4. */
  addRelationship(
    typeId: string,
    from: IResourceRef | string,
    to: IResourceRef | string,
  ...
  /** Declares an `executor_bindings` row for `target` (C1). See docs/iac/construct.md §5. */
  /**
  ...
  /** L1 ESCAPE HATCH for an org-defined role. See docs/iac/construct.md §6. */
  ...
  synth(): DesiredStateManifest {
    ...
    // TWO OBJECTS, ONE URN. See docs/iac/construct.md §7.
...
/** Base class for the 8 typed-registry resource constructs. See docs/iac/construct.md §8. */
...
/** A component (server-side object type `"component"`). See docs/iac/construct.md §9. */

...
/** Wave-organization guidance (team-pipeline-iac.md §8, D6 vocabulary). See docs/iac.md §320. */
...
/** One wave, in the relaxed shape a pipeline's `waves` prop accepts. See docs/iac.md §321. */
...
/** Normalizes a `WaveItem[]`. See docs/iac.md §322. */
...
/** A straight sequence of stages, one wave each. See docs/iac.md §323. */
...
/** `waves.widening(targets, { start, factor })`. See docs/iac.md §324. */
...
/** One wave per security-domain group, in the given order. See docs/iac.md §325. */

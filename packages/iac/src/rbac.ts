...
/** TYPED RBAC CONSTRUCTS. See docs/iac.md §306. */
...
/** Grants a role to a `user` or `service-account` at a scope. ``. See docs/iac.md §307. */
...
/** Declares an organization-defined role. ``. See docs/iac.md §308. */
...
/** Refuses a group subject with the reason and the alternative. See docs/iac.md §309. */

...
/** ABSENT — `null` OR `undefined`, never one of the two. See docs/cli/cli.md §1. */
...
/** One paired peer as a `scp federation peers` table row. See docs/cli/cli.md §2. */
...
/** `scp federation status` in table form. See docs/cli/cli.md §3. */
...
export function federationStatusRow(
  ...
  return {
    ...
    // M16.2 phase A (E3) — PENDING-EXPORT, never pending-apply. See docs/cli/cli.md §4.
...
/** M16.2 phase A (E1) — one `outpost` config object as a table row. See docs/cli/cli.md §5. */
...
/** The verdict line of `scp dependency-subscriptions resolve`. See docs/cli/cli.md §6. */
...
export function formatStageDependencyLines(
  ...
  // THE TWO ABSENCES ARE DIFFERENT CLAIMS AND ARE NOT COLLAPSED. See docs/cli/cli.md §7.
  if (status === undefined) {
    return standalone
...
// M2 typed registries (BUILD_AND_TEST.md §8 M2 item 1). See docs/cli/cli.md §8.
...
export function buildProgram(): Command {
  ...
  // doctor — read-only operational self-checks (`GET /doctor`). See docs/cli/cli.md §9.
  ...
  // M25.1 — THE EXITS. See docs/cli/cli.md §10.
  /** WHAT LIFTING COSTS. See docs/cli/cli.md §11. */
  freezeCmd
    .command("lift <id>")
    .description(
  ...
  /** WHAT EACH DIRECTION COSTS. See docs/cli/cli.md §12. */
  freezeCmd
    .command("update <id>")
    .description(
  ...
  // campaign (M5 Campaigns — DESIGN.md §9.5, BUILD_AND_TEST.md §8 M5). See docs/cli/cli.md §13.
  ...
  /** M25.6a (owner decision D4) — SET, MOVE or CLEAR the deadline. See docs/cli/cli.md §14. */
  campaignCmd
    .command("deadline <id>")
    .description(
  ...
  // instance scan-floors (M17.5 — ADR-0016). See docs/cli/cli.md §15.
  ...
  // instance scan-exclusion-admissions (M22.9 — ADR-0033 §1, §7a). See docs/cli/cli.md §16.
  ...
  scanAdmissionsCmd
    ...
    .action(
      async (
        ...
        // THE DESTRUCTIVE DEFAULT, MADE EXPLICIT. See docs/cli/cli.md §17.
  ...
  // instance scanner-assignments (M13.3a — ADR-0020 §2). See docs/cli/cli.md §18.
  ...
  // scan-db (M13.3b-ii — ADR-0020, proposal §13.3b). See docs/cli/cli.md §19.
  ...
  // dependency-subscriptions (M21.3 — ADR-0032 §3a, §6). See docs/cli/cli.md §20.
  ...
  // M21.2 (ADR-0032 §4) — the inventory backfill. See docs/cli/cli.md §21.
  depSubsCmd
  ...
  // THE HELP TEXT IS DERIVED FROM THE SCHEMA, NOT RETYPED. See docs/cli/cli.md §22.
  ...
  // THE RECOVERY VERB, ON THE ONLY SURFACE ITS OPERATOR CAN REACH. See docs/cli/cli.md §23.
  outpostCmd
    .command("reconcile")
    .description(
  ...
  // M15.5(c) — the retrans validate-then-relay (ADR-0019 §2). See docs/cli/cli.md §24.
  federationCmd
    .command("relay")
    .description(
  ...
  // `scp discovery backfill-mappings` IS GONE with the route it called. See docs/cli/cli.md §25.

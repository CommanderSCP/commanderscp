...
/** THE VALUE ALONE. See docs/runner-launcher/persisted-json-bound.test.md §1. */
...
/** THE CYCLE GUARD. See docs/runner-launcher/persisted-json-bound.test.md §2. */
...
describe("MEDIUM: a string field spends its share, not half of it", () => {
  ...
  it("WHAT A FIELD NEEDS, NOT A FLAT 96, decides which keys are seated", () => {
    ...
    // 69 fields plus the marker. See docs/runner-launcher/persisted-json-bound.test.md §3.
...
describe("HIGH: a refusal must be priced at what the content costs, not at a flat 96", () => {
  ...
  it("L + 96 IS THE WHOLE LAW: a value of L characters survives verbatim at L + 96, and not before", () => {
    // ONE LAW FOR EVERY SHAPE. See docs/runner-launcher/persisted-json-bound.test.md §4.

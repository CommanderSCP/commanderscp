...
function cluster(opts: { perRunSecrets?: boolean; runAsNonRoot?: boolean } = {}) {
  ...
  /** WHICH PORT STEP AN OP MARKS. See docs/runner-launcher/kubernetes-adapter.test.md §1. */
...
// M23.5 VERIFICATION PASS 18. See docs/runner-launcher/kubernetes-adapter.test.md §2.

/** A TRANSPORT THAT ANSWERS NOTHING. See docs/runner-launcher/kubernetes-adapter.test.md §3. */
...
/** THE KUBERNETES SUBSTRATE. See docs/runner-launcher/kubernetes-adapter.test.md §4. */

...
/** THE KUBERNETES ADAPTER. See docs/runner-launcher/kubernetes-adapter.md §1. */
...
/** WHAT THE RUN'S POD SAYS HAPPENED. See docs/runner-launcher/kubernetes-adapter.md §2. */
...
/** DID THE RUNNER CONTAINER EVER START? See docs/runner-launcher/kubernetes-adapter.md §3. */
...
/** WHY THIS RUN IS STILL WAITING. See docs/runner-launcher/kubernetes-adapter.md §4. */
...
/** WHAT THE JOB ITSELF SAYS HAPPENED. See docs/runner-launcher/kubernetes-adapter.md §5. */
...
/** WHAT THIS RUN OBSERVED. See docs/runner-launcher/kubernetes-adapter.md §6. */
...
export function kubernetesStartVerdict(
  ...
  // 2. THE UNSUSPEND WAS NEVER SENT. See docs/runner-launcher/kubernetes-adapter.md §7.
  ...
  return {
    ...
    async run(spec: RunnerSpec): Promise<RunnerResult> {
      ...
      try {
        ...
        /** IS THE BUDGET ALREADY GONE? See docs/runner-launcher/kubernetes-adapter.md §8. */
        ...
        try {
          ...
          // POLL TO A TERMINAL POD. See docs/runner-launcher/kubernetes-adapter.md §9.
          ...
          for (;;) {
            ...
            // NO TERMINAL POD. See docs/runner-launcher/kubernetes-adapter.md §10.
...
/** THE JOB MANIFEST. See docs/runner-launcher/kubernetes-adapter.md §11. */
...
/** NO KUBERNETES CLIENT LIBRARY. See docs/runner-launcher/kubernetes-adapter.md §12. */
...
/** THE SELECTING RESOLVER. See docs/runner-launcher/kubernetes-adapter.md §13. */

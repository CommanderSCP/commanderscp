...
/** Full graph model contract (DESIGN.md §4.1). See docs/schemas/graph.md §1. */
...
/** Which SIDE of an edge is singular. See docs/schemas/graph.md §2. */
...
export const CreateObjectRequestSchema = z.object({
  ...
  /** The containment parent. See docs/schemas/graph.md §3. */
  domainId: z
    .string()
    .uuid()
    .nullable()
...
/** Strict upsert-by-URN for a component (M12 P5a). See docs/schemas/graph.md §4. */
...
/** Rows that outlived the object they hang off. See docs/schemas/graph.md §5. */

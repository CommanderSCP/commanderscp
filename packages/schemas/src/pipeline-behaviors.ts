...
/** Every hook carries these. See docs/schemas/pipeline-behaviors.md §1. */
...
/** POST-MERGE — gates entry to WAVE 1. See docs/schemas/pipeline-behaviors.md §2. */
...
/** WHAT A PIECE OF EVIDENCE IS ABOUT. See docs/schemas/pipeline-behaviors.md §3. */
...
/** A concluded test run. See docs/schemas/pipeline-behaviors.md §4. */
...
/** ALARM STATE OVER A NAMED WINDOW. See docs/schemas/pipeline-behaviors.md §5. */
...
/** The push door's receipt. See docs/schemas/pipeline-behaviors.md §6. */

...
/** THE SHARED TRIVY PARSE. See docs/schemas/supply-chain.md §1. */
...
/** The class a finding row is written with. See docs/schemas/supply-chain.md §2. */
...
// M22.4 (ADR-0033 D1). See docs/schemas/supply-chain.md §3.
...
/** purl `type` → this project's `DependencyEcosystem`. See docs/schemas/supply-chain.md §4. */
...
/** THE REQUEST-BODY VALIDATOR. See docs/schemas/supply-chain.md §5. */
...
export const ScanApprovedOverridesSchema = z.object({
  ...
  /** THE DERIVED BAR. See docs/schemas/supply-chain.md §6. */
...
/** A grant's lifecycle, held in `properties.status`. See docs/schemas/supply-chain.md §7. */
...
/** RAISING a request. See docs/schemas/supply-chain.md §8. */
...
/** WHY EVERY EXCLUSION FOR A SCAN WAS REFUSED. See docs/schemas/supply-chain.md §9. */
...
/** THE CLASS'S OWN PREDICATE. See docs/schemas/supply-chain.md §10. */
...
function vendorLatestPredicate(
  ...
  return (finding) => {
    ...
    // A LANGUAGE PACKAGE → ITS OWN DECLARED LINE. See docs/schemas/supply-chain.md §11.
    const ecosystem = purlEcosystem(finding.purl);
    if (ecosystem === undefined || finding.pkgName === undefined) return false;
    // NO `InstalledVersion` ⇒ NO PASS. See docs/schemas/supply-chain.md §12.
...
export const ScanEvidenceSchema = z.object({
  /** WHICH scan method produced this verdict. See docs/schemas/supply-chain.md §13. */
...
/** A REFERENCE to a build-time SBOM. See docs/schemas/supply-chain.md §14. */

...
export const ChangeSchema = z.object({
  ...
  /** WHO cancelled this change (migration 0053). See docs/schemas/changes.md §1. */
...
/** THE OBSERVED-STATE SHAPE. See docs/schemas/changes.md §2. */
...
export const ChangeWaveTargetSchema = z.object({
  ...
  /** THE WAVE-TARGET FREEZE-HOLD PROJECTION. See docs/schemas/changes.md §3. */
  hold: z
    .object({
      freezes: z.array(
        z.object({
...
// ADR-0028 increment 4 — THE STAGE-DEPENDENCY WAIT STATUS. See docs/schemas/changes.md §4.
...
/** The TRANSFERRED phase. See docs/schemas/changes.md §5. */

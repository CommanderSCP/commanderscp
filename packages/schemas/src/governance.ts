...
export const ControlRunSchema = z.object({
  ...
  /** M22.8 — WHICH GATE CROSSING THIS RUN AUTHORIZED. See docs/schemas/governance.md §1. */
...
/** M22.9 — `GET /control-runs/{id}/findings`. See docs/schemas/governance.md §2. */
...
/** M25.1 — the body of `DELETE /api/v1/freezes/{id}`. See docs/schemas/governance.md §3. */

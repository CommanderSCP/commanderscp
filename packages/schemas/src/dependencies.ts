...
export const DependencyLineSchema = z.object({
  ...
  /** THE PRODUCER LINK IS NOT ON THIS ROW ANY MORE. See docs/schemas/dependencies.md §1. */
  /**
...
/** True iff the coordinate has a DECLARED producer. See docs/schemas/dependencies.md §2. */
...
/** The operator write body. See docs/schemas/dependencies.md §3. */
...
// M21.2 — THE INVENTORY BACKFILL (ADR-0032 §4). See docs/schemas/dependencies.md §4.
...
export const DeclareDependencyLineProducerRequestSchema = DependencyLineProducerKeySchema.extend({
  /** The producing COMPONENT's graph object id or URN. See docs/schemas/dependencies.md §5. */
...
/** The page query for both read routes. See docs/schemas/dependencies.md §6. */

...
/** THE AUTHOR'S DOOR. See docs/schemas/campaigns.md §1. */
export const CampaignRecipeSchema = z
  .strictObject({
    version: z.literal(1),
    trigger: z.strictObject({
      kind: CampaignRecipeTriggerKindSchema,
      /** VERBATIM into `TriggerIntent.parameters`. See docs/schemas/campaigns.md §2. */
...
/** THE STORED / READ SHAPE. See docs/schemas/campaigns.md §3. */
...
/** THE AUTHOR'S DOOR. See docs/schemas/campaigns.md §4. */
...
export const SetCampaignDeadlineRequestSchema = z.object({
  /** The new deadline, or `null` to clear it. See docs/schemas/campaigns.md §5. */
...
/** THREE VALUES, AND THE THIRD IS NOT A DEGRADED SECOND. See docs/schemas/campaigns.md §6. */

...
/** `@scp/coordination-as-code` desired-state manifest contract. See docs/schemas.md §299. */
  ...
  producers: z
    ...
    .describe(
      "Dependency-line producer declarations (ADR-0032 §7e). UNLIKE every other collection here, an ABSENT " +
        ...
        "Because Stack.synth() omits an empty collection, @scp/coordination-as-code cannot retract the LAST declaration — use " +
  ...
  governanceMoveRungs: z
    ...
    .describe(
      "governance:move enforcement rungs (ADR-0038 §2). LIKE 'producers' and UNLIKE every other collection here, " +
        ...
        "owns. Because Stack.synth() omits an empty collection, @scp/coordination-as-code cannot disable the LAST rung — use " +
  ...
  pipelineHooks: z
    ...
    .describe(
      "Pipeline test/bake hooks (D11/D21). LIKE 'producers' and 'governanceMoveRungs' and UNLIKE mappings/" +
        ...
        "component this stack owns. Because Stack.synth() omits an empty collection, @scp/coordination-as-code cannot remove " +

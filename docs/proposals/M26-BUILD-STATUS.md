...
- **M26.2 — GROUNDED, not yet coded.** Owner decisions settled 2026-08-24 (below); rail-4 seams verified against the code (below). Next action: execute rail 4 end-to-end in a focused pass, then rails 1/2, then rail 3 (verify-only), holding resync/audit-witness/doctor.

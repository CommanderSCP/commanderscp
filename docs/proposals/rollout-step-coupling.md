...
The qualifier is therefore phrased **"B is currently observed at ≥ N"**, with an explicit freshness bound measured off `last_observed_at`; a snapshot older than the bound is *unreadable* (§2.4 branch 3), not *satisfied*.

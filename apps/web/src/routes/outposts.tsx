...
/** THE ATTENTION-DOT COLUMN. See docs/web/routes/outposts.md §1. */
...
/** THE TIER CLAIM AND ITS QUALIFIER, DERIVED ONCE. See docs/web/routes/outposts.md §2. */
...
export function TrustTierCell({ status }: { status: FederationPeerStatus }): React.JSX.Element {
  // THE RETRANS BRANCH, DERIVED ONCE. See docs/web/routes/outposts.md §3.
...
/** OUTBOUND — PENDING-EXPORT, AND NOTHING MORE. See docs/web/routes/outposts.md §4. */
 ...
 */
/** THE HQ OUTPOST'S TIER. See docs/web/routes/outposts.md §5. */

...
/** THE COMPONENT PIPELINE. See docs/web/routes/component-pipeline.md §1. */
...
/** THE CORRELATED-INFRASTRUCTURE LANE. See docs/web/routes/component-pipeline.md §2. */
...
/** WHO MAINTAINS THIS PLACE. See docs/web/routes/component-pipeline.md §3. */
...
/** WHAT IS WITHHOLDING THIS STAGE'S RELEASE. See docs/web/routes/component-pipeline.md §4. */
...
/** THE REMOVE-PLACEMENT CONFIRM'S COPY. See docs/web/routes/component-pipeline.md §5. */
...
/** PLACE AT TARGET. See docs/web/routes/component-pipeline.md §6. */
...
/** Builds one lane's node chain. See docs/web/routes/component-pipeline.md §7. */
...
/** THE HEAD OF A LANE. See docs/web/routes/component-pipeline.md §8. */
/**
...
/** PIPELINE NODE ICONS. See docs/web/routes/component-pipeline.md §9. */
...
/** THE CHANGE-SOURCE KINDS THIS PAGE OFFERS. See docs/web/routes/component-pipeline.md §10. */
...
/** ADD SOURCE MAPPING. See docs/web/routes/component-pipeline.md §11. */
...
/** THE DELETE CONFIRM'S COPY. See docs/web/routes/component-pipeline.md §12. */
...
function SourceNode({
  ...
  // ONE TILE PER SOURCE. See docs/web/routes/component-pipeline.md §13.
  ...
  return (
    <div className="w-full" data-testid="pipeline-node-source">
      ...
      {tileCount === 0 ? (
        ...
        >
          {hasCommanderInput && (
            // THE COMMANDER AS AN OPAQUE INPUT. See docs/web/routes/component-pipeline.md §14.
...
/** ONE SOURCE TILE. See docs/web/routes/component-pipeline.md §15. */
function SourceTile({
  source,
  provenance,
  componentId,
  ...
  // THE ARROW IS THE SWITCH. See docs/web/routes/component-pipeline.md §16.
  const queryClient = useQueryClient();
            ...
            const renderRow = (source: ComponentPipelineResponse["sources"][number]) => (
              <div key={source.id} data-testid="pipeline-source-mapping">
                ...
                {source.refPattern ? (
                  ...
                  // dev-branch-pipelines ADR, not this branch's ADR-0036).
                  <span
                    className="text-amber-700"
...
/** THE OPEN/CLOSE DIALOG. See docs/web/routes/component-pipeline.md §17. */
...
/** A BUILD NODE. See docs/web/routes/component-pipeline.md §18. */
function BuildNode({
  bindings,
  artifact,
  observedRun
...
/** A REGISTRY NODE. See docs/web/routes/component-pipeline.md §19. */
...
/** THE GATE INTO A STAGE. See docs/web/routes/component-pipeline.md §20. */
/** THE ENTRY GATE OF ONE STAGE. See docs/web/routes/component-pipeline.md §21. */
/**
...
/** THE ENTRY GATE AS ONE LINE. See docs/web/routes/component-pipeline.md §22. */
...
/** THE PROVENANCE SENTENCE. See docs/web/routes/component-pipeline.md §23. */
...
/** THE CORRELATED-INFRASTRUCTURE SECTION. See docs/web/routes/component-pipeline.md §24. */

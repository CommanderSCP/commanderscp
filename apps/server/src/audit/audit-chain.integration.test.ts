...
import { createTestOrg, listenTestServer, testDatabaseUrl, type ListeningTestServer } from "../test-support/harness.js";
...
describe("audit chain: 10,000 mixed writes", () => {
  it(
    "verifies via `scp audit verify` after 10k creates/updates/relationships",
    async () => {

...
/** THE BACKGROUND-WORK COMPOSITION. See docs/background-work.md §1. */
...
/** Does THIS process own background work? See docs/background-work.md §2. */
export function runsBackgroundWork(config: Pick<ServerConfig, "role">): boolean {
  return config.role === "all" || config.role === "worker";
}

/** Does THIS process CREATE the bootstrap admin? See docs/background-work.md §3. */

  ...
  typed.route({
    ...
    handler: async (request, reply) => {
      ...
      const role = await withTenantTx(deps.db, auth.orgId, async (tx) => {
        ...
        // A BUILT-IN IS NOT EDITABLE THROUGH ANY ORG'S API. See docs/routes/role-bindings.md §1.
  ...
  typed.route({
    ...
    handler: async (request, reply) => {
      ...
      await withTenantTx(deps.db, auth.orgId, async (tx) => {
        ...
        // REFUSES WITH BINDINGS, rather than cascading. See docs/routes/role-bindings.md §2.
  ...
  typed.route({
    ...
    handler: async (request, reply) => {
      ...
      const body = await withTenantTx(deps.db, auth.orgId, async (tx) => {
        ...
        // §2d — THE PROJECTION FILTER. See docs/routes/role-bindings.md §3.
      ...
      const result = await withTenantTx(deps.db, auth.orgId, async (tx) => {
        ...
        return withIdempotency(
          ...
          async () => {
            ...
            // 3 — the two objects. See docs/routes/role-bindings.md §4.
  ...
  typed.route({
    ...
    handler: async (request, reply) => {
      ...
      const revoked = await withTenantTx(deps.db, auth.orgId, async (tx) => {
        ...
        // THE ADMINISTRATOR FLOOR. See docs/routes/role-bindings.md §5.

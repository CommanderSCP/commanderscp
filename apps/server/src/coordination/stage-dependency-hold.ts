...
/** ADR-0028 increment 3 — THE HOLD. See docs/coordination/stage-dependency-hold.md §1. */
...
/** One dependency's verdict at one place. See docs/coordination/stage-dependency-hold.md §2. */
...
export async function evaluateStageDependencies(
  ...
  if (!stage) {
    // LEGACY-SHAPED WAVE TARGET. See docs/coordination/stage-dependency-hold.md §3.

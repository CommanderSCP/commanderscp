...
/** THE CAMPAIGN ROW, LOCKED `FOR UPDATE`. See docs/coordination/campaign-repo.md §1. */
...
export async function setCampaignDeadline(
  ...
  input: {
    ...
    actorObjectId: string;
    requestId: string;
    /** `null` CLEARS it — the exit. See docs/coordination/campaign-repo.md §2. */
...
export async function getCampaignStatus(
  ...
  // THE COST GUARD. See docs/coordination/campaign-repo.md §3.

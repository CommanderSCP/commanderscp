...
/** `decisions.kind` for the lock. See docs/coordination/campaign-deadline-lock.md §1. */
...
export async function evaluateCampaignDeadlineLock(
  ...
  // NOT DUE => INERT. See docs/coordination/campaign-deadline-lock.md §2.
  ...
  for (const targetObjectId of input.targetObjectIds) {
    ...
    // THE ONE RESOLUTION CORE. See docs/coordination/campaign-deadline-lock.md §3.

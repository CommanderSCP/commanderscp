...
/** A COMPONENT'S PIPELINE. See docs/coordination/component-pipeline.md §1. */
...
/** WHAT GATES ENTRY TO ONE STAGE. See docs/coordination/component-pipeline.md §2. */
/**
...
export async function getComponentPipeline(
  ...
  for (const p of prepared) {
    ...
    // THE VERSION STAIRCASE. See docs/coordination/component-pipeline.md §3.
...
/** THE CORRELATED-INFRASTRUCTURE LANE. See docs/coordination/component-pipeline.md §4. */

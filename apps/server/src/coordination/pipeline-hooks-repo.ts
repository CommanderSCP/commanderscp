...
/** WHO PRODUCED a piece of evidence. See docs/coordination/pipeline-hooks-repo.md §1. */
...
export async function recordTestRunEvidence(
  ...
  // OUTPOST-RUN PROBES, THE UPWARD HALF. See docs/coordination/pipeline-hooks-repo.md §2.
  if (input.federationImport !== true)
    await appendJournalEntry(tx, {
      orgId,
...
/** Records one alarm-state report. See docs/coordination/pipeline-hooks-repo.md §3. */

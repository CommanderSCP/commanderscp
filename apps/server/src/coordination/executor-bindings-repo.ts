 ...
 */
/** THE LANE FALLBACK, IN ONE PLACE. See docs/coordination/executor-bindings-repo.md §1. */
...
export async function deleteExecutorBinding(
  ...
  actorObjectId: string,
  requestId: string,
  /** WHICH LANE to delete. See docs/coordination/executor-bindings-repo.md §2. */
  lane: ExecutorLane = "build"
): Promise<ExecutorBindingRow | undefined> {
...
function managedRunnerKubernetesSettings(): KubernetesLauncherSettings | undefined {
  ...
  return {
    ...
    workspaceRoot,
    workspaceVolume,
    // THE GRANTED CAPABILITY. See docs/coordination/executor-bindings-repo.md §3.

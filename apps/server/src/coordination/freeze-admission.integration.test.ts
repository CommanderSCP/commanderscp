...
describe("freeze admission: per-target holds, whole-wave blocks, and what is exempt (M25.2)", () => {
  ...
  // D7, READ SIDE. See docs/coordination/freeze-admission.integration.test.md §1.
  ...
  it("H: EVERY active freeze must be overridden at its OWN scope — a universal quantifier, tested with two", async () => {
    ...
    // (c) THE QUANTIFIER. See docs/coordination/freeze-admission.integration.test.md §2.
  ...
  // M25.7 / D6 AUTHORING DOOR. See docs/coordination/freeze-admission.integration.test.md §3.
  ...
  // D6 GATE, THE OTHER TWO VERBS. See docs/coordination/freeze-admission.integration.test.md §4.
  ...
  it("dedup (multi): two held targets under two freezes, with BOTH source orders reversed", async () => {
    // THE FIXTURE IS THE TEST. See docs/coordination/freeze-admission.integration.test.md §5.
  ...
  it("M25.1: a PATCH that moves `endsAt` NOWHERE is recorded as `unchanged`, not as an extension", async () => {
    // EQUALITY IS ITS OWN CASE. See docs/coordination/freeze-admission.integration.test.md §6.
  ...
  // M25.9 — THE ACTOR LADDER. See docs/coordination/freeze-admission.integration.test.md §7.

...
/** Auto-cancelled must be distinguishable from user-cancelled. See docs/coordination.md §241. */
describe("cancellation kind: engine vs human", () => {
  ...
  it("a NON-cancel transition writes no kind — the field is about cancelling, not about acting", async () => {
    // This test drives a real transition on purpose. See docs/coordination.md §242.

...
/** PER-TARGET FREEZE RESOLUTION. See docs/governance/freeze-scope.md §1. */

/** ONE FREEZE IN FORCE, FROM EITHER TIER. See docs/governance/freeze-scope.md §2. */
...
export async function freezesByTarget(
  ...
  for (const targetObjectId of targetObjectIds) {
    ...
    // THE INSTANCE TIER FIRST. See docs/governance/freeze-scope.md §3.
    ...
    // THE ORG TIER. See docs/governance/freeze-scope.md §4.

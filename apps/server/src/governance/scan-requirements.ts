...
/** The six-tier label for a graph object type. See docs/governance/scan-requirements.md §1. */
export function tierForObjectType(objectTypeId: string): ScanRequirementTier {
  switch (objectTypeId) {
    ...
    case "service":
      return "service";
    case "assembly":
      // M22.0 (ADR-0033 §5). See docs/governance/scan-requirements.md §2.
      return "assembly";
    default:
      return "component";
  }
...
/** THE PER-TARGET GATHER. See docs/governance/scan-requirements.md §3. */
...
/** M22.6 (D3), THE DERIVED BAR. See docs/governance/scan-requirements.md §4. */

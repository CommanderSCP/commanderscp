...
/** THE HEAD OF A LINE. See docs/dependencies/version-index.md §1. */
...
/** Resolve ONE line's head. See docs/dependencies/version-index.md §2. */
export async function queryLineHead(
  ...
  // A MUTABLE TAG IS NOT AN IDENTITY. See docs/dependencies/version-index.md §3.

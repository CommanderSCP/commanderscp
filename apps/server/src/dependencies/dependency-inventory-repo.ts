...
export async function recordDependencyLineHead(
  ...
  /** WHICH INGRESS IS ASKING. See docs/dependencies/dependency-inventory-repo.md §1. */
  ...
  // THE PAIR MOVES TOGETHER. See docs/dependencies/dependency-inventory-repo.md §2.
  const latestDigest =
  ...
  // AND THIS IS WHERE THE BUMP STARTS. See docs/dependencies/dependency-inventory-repo.md §3.

...
/** THE DELEGATION RE-CHECK. See docs/dependencies/bump-actuator.md §1. */
...
/** Does this control run's evidence name `repo`? See docs/dependencies/bump-actuator.md §2. */
...
export interface RecordBumpChangeInput {
  ...
  requestId: string;
  componentObjectId: string;
  /** The dependency line this bump is for. See docs/dependencies/bump-actuator.md §3. */
  lineId: string;
...
/** THE PROVENANCE LOOP. See docs/dependencies/bump-actuator.md §4. */

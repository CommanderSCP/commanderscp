...
export function planBump(input: {
  ...
  // A DECLARATION PINNED TWICE. See docs/dependencies/bump-dispatch.md §1.
...
/** Run ONE queued job. See docs/dependencies/bump-dispatch.md §2. */
...
async function dispatchForComponent(
  ...
  // AND THE BINDING MUST NAME THAT REPOSITORY. See docs/dependencies/bump-dispatch.md §3.
...
/** Register the capability's worker. See docs/dependencies/bump-dispatch.md §4. */

...
/** THE COMMANDER-SIDE PROMOTION SCAN STEP. See docs/federation/promotion-scan-step.md §1. */
...
/** THE EXCLUSION SET IN FORCE FOR A CHANGE. See docs/federation/promotion-scan-step.md §2. */
...
interface ParsedOscap {
  severityCounts: ScanSeverityCounts;
  /** M22.1b — `never`, not "empty". See docs/federation/promotion-scan-step.md §3. */
  findings?: never;

...
/** THE RECOVERY DOOR. See docs/federation/outposts-repo.md §1. */
export async function reconcileOutpostConfig(
  ...
  if (unremovable.length > 0) {
    // 409, NOT 404. See docs/federation/outposts-repo.md §2.
    throw conflict(
...
/** Edits the commander-origin config. See docs/federation/outposts-repo.md §3. */

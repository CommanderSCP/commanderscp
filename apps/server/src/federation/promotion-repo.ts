...
/** M17.3 (E6) EXPORT SCAN GATE. See docs/federation/promotion-repo.md §1. */
...
export async function exportPromotionBundle(
  ...
  const gathered = await withTenantTx(db, input.orgId, async (tx) => {
    ...
    // M17.3 (E6) EXPORT SCAN GATE. See docs/federation/promotion-repo.md §2.
...
/** Import a Promotion Bundle. See docs/federation/promotion-repo.md §3. */

...
/** Is `dir` at or under one of `roots`? See docs/federation/delivery-target.md §1. */
...
/** Is `endpoint`+`bucket` allowed by `allow`? See docs/federation/delivery-target.md §2. */
...
/** One direction of the resolved view. See docs/federation/delivery-target.md §3. */
...
/** S3 direction resolution (13.2b). See docs/federation/delivery-target.md §4. */

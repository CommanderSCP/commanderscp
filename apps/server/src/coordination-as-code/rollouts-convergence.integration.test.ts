...
/** ROLLOUTS AND CONVERGENCE SURVIVE APPLY. See docs/coordination-as-code.md §50. */
describe("IaC: rollouts and convergence reach the database", () => {
  ...
  async function fixture(label: string): Promise<Fixture> {
    ...
    // THE COMPONENT MUST BE DECLARED BY THIS STACK, not created beside it. See docs/coordination-as-code.md §51.

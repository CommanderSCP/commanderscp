...
/** THE IaC RUNG OF THE PRODUCER DECLARATION. See docs/coordination-as-code.md §18. */
describe("iac: dependency-line producer declarations (ADR-0032 §7e)", () => {
  ...
  describe("(1) an ABSENT producers key manages NOTHING", () => {
    it("a stack with a STANDING declaration, whose manifest omits the key, plans NO producer entries and the declaration survives apply", async () => {
      ...
      // The shape, which catches that edit one step earlier. See docs/coordination-as-code.md §19.
  ...
  /** That table is keyed on the coordinate and upserted. See docs/coordination-as-code.md §20. */
  describe("(7) a plan is re-checked against the LIVE holder at apply time", () => {
    ...
    /** The apply, driven to completion whichever way it goes. See docs/coordination-as-code.md §21. */
  ...
  /** THE GUARD THIS PINS WAS HELD BY NOTHING. See docs/coordination-as-code.md §22. */
  ...
  /** A tombstoned producer component leaves its declaration STANDING. See docs/coordination-as-code.md §23. */

...
/** ADOPTION, AND THE THEFT IT IS NOT (proposal section 9, increment 7). See docs/coordination-as-code.md §4. */
describe("IaC adoption and stack-theft refusal", () => {
  ...
  it("(2) the noop+adopted branch is reachable exactly where the LABELS LIE — which is why the column exists", async () => {
    ...
    // A measured correction to this case's first expectation. See docs/coordination-as-code.md §5.

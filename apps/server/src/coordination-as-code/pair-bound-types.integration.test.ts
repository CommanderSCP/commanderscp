...
/** An apply must refuse a pair-bound type, as the route does. See docs/coordination-as-code.md §29. */
describe("IaC apply refuses pair-bound object types", () => {
  ...
  // THE `accept` CASE IS GONE WITH ITS DOOR. See docs/coordination-as-code.md §30.

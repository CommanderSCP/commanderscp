 ...
 * kind (pipeline-mockup-data.md D3/D4, drizzle/0116).
 *
 ...
 * `secret:write` at the org root, the class that guards setting a secret, minting a CA and M28.2's
 * Argo host-ops pin — and it is never replicated.
 */

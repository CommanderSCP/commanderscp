...
/** RBAC permission resolution (DESIGN.md §7). See docs/authz/resolve.md §1. */
/** THE PERMISSION CATALOGUE. See docs/authz/resolve.md §2. */
export const PERMISSIONS = [
  ...
  "federation:read",
  "federation:write",
  // THE SECOND BAR ON PAIRING. See docs/authz/resolve.md §3.
  "federation:pair",
  ...
  // THE THREE PERMISSION SPLITS. See docs/authz/resolve.md §4.
...
/** THE INVERSE WALK. See docs/authz/resolve.md §5. */
...
export async function effectivePermissions(
  ...
  // ADR-0037, INHERITED DELIBERATELY. See docs/authz/resolve.md §6.

...
// Allowed bundled backends per federation role. See docs/helm-verify/verify.md §1.
...
/** M23.6 CLAUSE 5. See docs/helm-verify/verify.md §2. */
function rbacDiff(
  rendered: unknown,
...
/** The runner Job THIS RENDER WOULD PRODUCE. See docs/helm-verify/verify.md §3. */
...
interface MatrixPoint {
  ...
  refuses: boolean;
  /** M23.6 CLAUSE 5, WIDENED. See docs/helm-verify/verify.md §4. */
  expectRunnerGrant: boolean;
  perRunSecrets: boolean;
}

/** The exhaustive product. See docs/helm-verify/verify.md §5. */
function socketMatrix(): MatrixPoint[] {
  ...
  /** THE BUNDLED BACKENDS' OWN IDENTITIES. See docs/helm-verify/verify.md §6. */
...
function verifySocketInvariantMatrix(): void {
  ...
  for (const point of points) {
    ...
    /** M23.6 CLAUSE 5, WIDENED. See docs/helm-verify/verify.md §7. */
  ...
  for (const { file, text } of chartSources) {
    ...
    /** M23.6 CLAUSE 5, WIDENED. See docs/helm-verify/verify.md §8. */
  ...
  /** AND THE GRANT DETECTOR'S OWN NON-VACUITY. See docs/helm-verify/verify.md §9. */
...
/** The RAW `helm template` output. See docs/helm-verify/verify.md §10. */
...
/** THE AIR-GAP REGRESSION GUARD. See docs/helm-verify/verify.md §11. */
...
function verifyRender(label: string, docs: K8sDoc[]): void {
  ...
  // Bundled executor backends. See docs/helm-verify/verify.md §12.
...
function main(): void {
  ...
  // AIR-GAP REGRESSION GUARD. See docs/helm-verify/verify.md §13.
  console.log(
  ...
  for (const be of ["argocd", "gitea"]) {
    ...
    // THE SAME POST-DNAT RULE, APPLIED TO THE BACKEND ITSELF. See docs/helm-verify/verify.md §14.
  ...
  // NEGATIVE case — PROVE the guard above actually fires. See docs/helm-verify/verify.md §15.
  {
  ...
  // NEGATIVE case — WIDENING. See docs/helm-verify/verify.md §16.
  {
  ...
  // which is exactly why the hole survived review.
  {
    ...
    // NOT a bare count. See docs/helm-verify/verify.md §17.
  ...
  // OPERATOR CONFIG SURFACE. See docs/helm-verify/verify.md §18.
  console.log(
  ...
  // timeout — which is the worst place to discover any of it.
  {
    ...
    // (3c) THE ROLE FOLLOWS THE RUNNER NAMESPACE. See docs/helm-verify/verify.md §19.
    {
